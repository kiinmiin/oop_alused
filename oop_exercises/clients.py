...
class Client:
    ...
    def earnings_per_day(self):
        ...
        """
        self.per_day_1st = self.current_amount - self.starting_amount
        self.per_day_2nd = self.per_day_1st / self.account_age
        return self.per_day_2nd
        pass
...
def read_from_file_into_list(filename: str) -> list:
    ...
    with open(filename, 'r') as f:
        ...
        for line in lines:
            ...
            client_list.append(Client(fields[0], fields[1], int(fields[2]), int(fields[3]), int(fields[4])))
    return client_list
    pass
...
def largest_earnings_per_day(filename: str) -> Optional[Client]:
    ...
    for client in clients:
        if client.earnings_per_day() <= 0:
            ...
            return client
    # sorted_by_earnings = sorted(clients, key=lambda client: client.earnings_per_day(), reverse=True)
    # sorted_by_account_age = sorted(sorted_by_earnings, key=lambda client: client.account_age)
    # return sorted_by_account_age[0]
    pass
